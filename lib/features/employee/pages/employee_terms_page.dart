...
class EmployeeTermsPage extends StatelessWidget {
  const EmployeeTermsPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Terms & Disclaimer', style: TextStyle(color: Color(0xFF1A1A3F), fontWeight: FontWeight.w900, fontSize: 16)),
        centerTitle: true,
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text('Terms of Service / Disclaimer', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Color(0xFF1A1A3F))),
              const SizedBox(height: 12),
              const Text(
                'Please read these terms carefully. They outline the responsibilities and guidelines for all platform users.',
                textAlign: TextAlign.center,
                style: TextStyle(color: Colors.black38, fontSize: 13, fontWeight: FontWeight.w600, height: 1.5),
              ),
  ...
  Widget _buildIconHeader() {
    return Container(
      ...
      child: const Icon(Icons.description_rounded, color: Color(0xFF4A90E2), size: 40),
    );
  }

  Widget _buildLegalSection({required String title, required Color color, required IconData icon, required List<String> rules}) {
    return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        rule,
                        style: const TextStyle(color: Colors.black54, fontSize: 13, height: 1.5, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildDisclaimerBox() {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(color: const Color(0xFF1A1A3F), borderRadius: BorderRadius.circular(24)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 12),
              Text('Disclaimer', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
            ],
          ),
          ...
          Text(
            ...
            style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 12, height: 1.6, fontWeight: FontWeight.w500),
          ),
        ],
      ),
    );
  ...
  Widget _buildSupportBox() {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(color: const Color(0xFFF1F3F5).withOpacity(0.5), borderRadius: BorderRadius.circular(24)),
      child: Column(
        children: [
          const Icon(Icons.support_agent_rounded, color: Color(0xFF4A90E2), size: 32),
          const SizedBox(height: 12),
          const Text('Need Help?', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Color(0xFF1A1A3F))),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Text('Contact Support', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 15)),
            ),
          ),
        ],
      ),
