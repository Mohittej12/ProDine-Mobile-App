  ...
  Future<void> _submit(BuildContext context, AuthProvider authProvider) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(authProvider.errorMessage ?? 'Admin sign in failed'),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF0A4C6A),
      ),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Use admin credentials provided separately from employee login.',
